...
"""
post_met_api = Blueprint('post_met_api', __name__, url_prefix='/api')
...
class PostAPI:
    ...
    """
    api.add_resource(_CRUD, '/postmet')
    api.add_resource(_USER, '/postmet/user')
    api.add_resource(_BULK_CRUD, '/postsmet')
    api.add_resource(_FILTER, '/postsmet/filter')