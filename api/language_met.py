...
language_met_api = Blueprint('language_met_api', __name__, url_prefix='/api')

# Create an Api object and associate it with the Blueprint
api = Api(language_met_api)
...
api.add_resource(LanguageAPI._Language, '/languagemet')
api.add_resource(LanguageAPI._Popularity, '/languagemet/popularity')