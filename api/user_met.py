...
user_met_api = Blueprint('user_met_api', __name__, url_prefix='/api')

# Create an Api object and associate it with the Blueprint
# API docs: https://flask-restful.readthedocs.io/en/latest/api.html
api = Api(user_met_api)
...
api.add_resource(UserAPI._BULK_CRUD, '/usersmet')
api.add_resource(UserAPI._CRUD, '/usermet')
api.add_resource(UserAPI._Security, '/authenticatemet')
api.add_resource(UserAPI._Followers, '/followersmet')